                                ...
                                <div class="card dash-product-box shadow-none border mb-0">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-17 mt-1">
                                            <a href="ecommerce-product-detail" class="text-dark lh-base">Stylish Cricket & Walking Light Weight Shoes</a>
                                        </h5>
                                        ...
                                        <div class="mt-4">
                                            <a href="ecommerce-product-detail" class="btn btn-primary btn-sm w-lg"><i class="mdi mdi-cart me-1 align-middle"></i> Buy
                                                Now</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card dash-product-box shadow-none border mb-0">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-17 mt-1">
                                            <a href="ecommerce-product-detail" class="text-dark lh-base">Combo Pack of 2 Sports Shoes Running Shoes</a>
                                        </h5>
                            ...
                            <div class="swiper-slide">
                                <div class="card dash-product-box shadow-none border mb-0">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-17 mt-1">
                                            <a href="ecommerce-product-detail" class="text-dark lh-base">Trendy Men Sports Running Running Shoes</a>
                                        </h5>
                            ...
                            <div class="swiper-slide">
                                <div class="card dash-product-box shadow-none border mb-0">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-17 mt-1">
                                            <a href="ecommerce-product-detail" class="text-dark lh-base">Sneakers For Women Sports Running Shoes (Blue)</a>
                                        </h5>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{URL::asset('assets/images/users/avatar-1.jp')}}g" alt="" class="avatar rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{URL::asset('assets/images/users/avatar-2.jp')}}g" alt="" class="avatar rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{URL::asset('assets/images/users/avatar-3.jp')}}g" alt="" class="avatar rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{URL::asset('assets/images/users/avatar-4.jp')}}g" alt="" class="avatar rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{URL::asset('assets/images/users/avatar-5.jp')}}g" alt="" class="avatar rounded-circle">
                                            </div>
