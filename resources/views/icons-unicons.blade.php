...
@section('title')Unicons @endsection
@section('content')
{{-- breadcrumbs  --}}
    @section('breadcrumb')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header justify-content-between d-flex align-items-center">
                <h4 class="card-title">Unicons</h4>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                <div class="row icon-demo-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-align-center-justify"></i> uil-align-center-justify
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-arrow-resize-diagonal"></i> uil-arrow-resize-diagonal
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-assistive-listening-systems"></i> uil-assistive-listening-systems
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-cloud-data-connection"></i> uil-cloud-data-connection
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-comment-alt-chart-lines"></i> uil-comment-alt-chart-lines
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-comment-alt-download"></i> uil-comment-alt-download
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-comment-alt-edit"></i> uil-comment-alt-edit
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-comment-alt-exclamation"></i> uil-comment-alt-exclamation
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-comment-alt-question"></i> uil-comment-alt-question
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-corner-down-right-alt"></i> uil-corner-down-right-alt
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-crop-alt-rotate-left"></i> uil-crop-alt-rotate-left
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-crop-alt-rotate-right"></i> uil-crop-alt-rotate-right
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-document-layout-left"></i> uil-document-layout-left
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-document-layout-right"></i> uil-document-layout-right
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-envelope-download-alt"></i> uil-envelope-download-alt
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-envelope-exclamation"></i> uil-envelope-exclamation
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-exclamation-triangle"></i> uil-exclamation-triangle
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-facebook-messenger-alt"></i> uil-facebook-messenger-alt
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-file-contract-dollar"></i> uil-file-contract-dollar
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-file-exclamation-alt"></i> uil-file-exclamation-alt
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-files-landscapes-alt"></i> uil-files-landscapes-alt
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-forecastcloud-moon-tear"></i> uil-forecastcloud-moon-tear
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-glass-martini-alt-slash"></i> uil-glass-martini-alt-slash
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-grin-tongue-wink-alt"></i> uil-grin-tongue-wink-alt
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-horizontal-align-center"></i> uil-horizontal-align-center
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-horizontal-align-left"></i> uil-horizontal-align-left
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-horizontal-align-right"></i> uil-horizontal-align-right
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-horizontal-distribution-center"></i> uil-horizontal-distribution-center
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-horizontal-distribution-left"></i> uil-horizontal-distribution-left
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-horizontal-distribution-right"></i> uil-horizontal-distribution-right
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-image-resize-landscape"></i> uil-image-resize-landscape
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-left-arrow-from-left"></i> uil-left-arrow-from-left
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-left-to-right-text-direction"></i> uil-left-to-right-text-direction
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-presentation-lines-alt"></i> uil-presentation-lines-alt
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-right-to-left-text-direction"></i> uil-right-to-left-text-direction
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-smile-squint-wink-alt"></i> uil-smile-squint-wink-alt
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-step-backward-circle"></i> uil-step-backward-circle
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-temperature-three-quarter"></i> uil-temperature-three-quarter
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-vertical-align-bottom"></i> uil-vertical-align-bottom
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-vertical-align-center"></i> uil-vertical-align-center
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-vertical-align-top"></i> uil-vertical-align-top
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-vertical-distribute-bottom"></i> uil-vertical-distribute-bottom
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-vertical-distribution-center"></i> uil-vertical-distribution-center
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <i class="uil-vertical-distribution-top"></i> uil-vertical-distribution-top
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
