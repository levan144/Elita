...
<div class="row">
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="font-size-17 me-3 mb-0">My Files</h5>
                <div class="row mt-4">
                        ...
                        <div class="card border">
                            <div class="card-body">
                                <div class="">
                                    ...
                                    <div class="mt-3">
                                        <p class="mb-0 text-muted"><i class="mdi mdi-clock me-1"></i> Last Changes: 23.05.2022</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <h5 class="font-size-17 me-3 mb-0">Folders</h5>
                <div class="row mt-4">
                    <div class="col-xl-4 col-sm-6">
                        <div class="card border">
                ...
                <h5 class="font-size-17 me-3 mb-0">Co-owners</h5>
                <div class="row mt-4">
                                ...
                                <div class="">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a href="" class="font-size-13 text-muted"><u>Con Edit</u></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card border">
                            <div class="card-body">
                                <div class="">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar align-self-center me-3">
                                            <img src="{{URL::asset('assets/images/users/avatar-9.jpg')}}" alt="" class="avatar rounded">
                                        </div>
                ...
                <div class="d-flex flex-wrap">
                    <h5 class="font-size-17 me-3">Recent Files</h5>
                    <div class="ms-auto">
                ...
                <div class="mx-n4 px-4" data-simplebar style="height: 280px;">
    ...
    <div class="col-xl-3">
        <div class="card">
            <div class="card-body">
                <div class="">
                    <h5 class="font-size-17">Usage Storage</h5>
                    <div class="text-center">
                        <div class="apex-charts" data-colors='["--bs-primary"]' id="radial-chart"></div>
