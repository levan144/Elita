                    ...
                    <table class="table table-centered mb-0 table-nowrap">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail" class="text-dark">Nike N012 Running Shoes</a></h5>
                                    <p class="text-muted mb-0">$ 260 x 2</p>
                                </td>
                                <td>$ 520</td>
                            </tr>
                            <tr>
                                <th scope="row"><img src="{{URL::asset('assets/images/product/img-2.png')}}" alt="product-img" title="product-img" class="avatar-md"></th>
                                <td>
                                    <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail" class="text-dark">Adidas Running Shoes</a></h5>
