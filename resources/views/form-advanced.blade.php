                        ...
                        <div class="mt-4 mt-xl-0">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <div class="square-switch">
                                    ...
                                    <label for="square-switch1" data-on-label="On" data-off-label="Off" class="mb-0"></label>
                                </div>
                                <div class="square-switch">
                                    <input type="checkbox" id="square-switch2" switch="info" checked />
                                    <label for="square-switch2" data-on-label="Yes" data-off-label="No" class="mb-0"></label>
                                </div>
                                <div class="square-switch">
                                    <input type="checkbox" id="square-switch3" switch="bool" checked />
                                    <label for="square-switch3" data-on-label="Yes" data-off-label="No" class="mb-0"></label>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="choices-text-remove-button" type="text" value="Task-1,Task-2" />
                            </div>
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="choices-text-unique-values" type="text" value="Project-A, Project-B" />
                            </div>
                        </div>
                        <!-- end col -->
                    </div>
                    ...
                    <div>
                        ...
                        <input class="form-control" id="choices-text-disabled" type="text" value="josh@joshuajohnson.co.uk, joe@bloggs.co.uk" />
                    </div>
                </div>
            </div>
            <!-- end card body -->
