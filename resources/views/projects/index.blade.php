...
@section('title') {{__('projects.title')}} @endsection
@section('content')
{{-- breadcrumbs  --}}
    @section('breadcrumb')
        @component('components.breadcrumb')
            @slot('li_1') {{__('header.page_title')}} @endslot
            @slot('title') {{__('projects.page_title')}} @endslot
        @endcomponent
    @endsection
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            <a href="{{route('projects.create')}}" class="btn btn-light">
                                <i class="uil uil-plus me-1"></i> {{__('projects.button.add_new')}}
                            </a>
                        </div>
                    </div><!-- end col -->
                    <div class="col-md-9">
                        <div class="d-flex flex-wrap align-items-start justify-content-md-end gap-2 mb-3">
                            <div class="search-box ">
                                <div class="position-relative">
                                    <input type="text" class="form-control bg-light border-light rounded" placeholder="{{__('global.search_placeholder')}}">
                ...
                <div class="mt-2">
                    <ul class="nav nav-tabs nav-tabs-custom mb-4" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#grid-all" role="tab">{{__('projects.status.all')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#grid-active">{{__('projects.status.active')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#grid-complete">{{__('projects.status.completed')}}</a>
                        </li>
                    </ul><!-- end ul -->
                </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="grid-all" role="tabpanel">
                        ...
                        <div class="row g-0">
                            <div class="col-sm-6">
                                <div>
                                    <p class="mb-sm-0">{{ __('global.pagination', ['start' => 1, 'end' => 8, 'total' => 24]) }}</p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge badge-soft-warning font-size-12"><i class="mdi mdi-clock-outline font-size-14 me-1 align-middle"></i> {{ __('projects.days_left', ['count' => 3]) }}</span>
                                                <div class="avatar-group align-items-center">
                                                    <div class="me-4">Team :</div>
                                                    <div class="avatar-group-item">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge badge-soft-success font-size-12"><i class="mdi mdi-clock-outline font-size-14 me-1 align-middle"></i> {{ __('projects.days_left', ['count' => 1]) }}</span>
                                                <div class="avatar-group align-items-center">
                                                    <div class="avatar-group-item">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge badge-soft-danger font-size-12"><i class="mdi mdi-clock-outline font-size-14 me-1 align-middle"></i> {{ __('projects.days_left', ['count' => 3]) }}</span>
                                                <div class="avatar-group align-items-center">
                                                    <div class="avatar-group-item">
                                                        <a href="javascript: void(0);" class="d-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Megan Seaton">
                                                            <img src="{{URL::asset('assets/images/users/avatar-4.jpg')}}" alt="" class="rounded-circle avatar-sm">
