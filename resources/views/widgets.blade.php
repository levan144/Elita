                    ...
                    <div class="col-sm-7">
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <h5>$12,582<small class="badge badge-soft-success font-13 ms-2">+15%</small></h5>
                            </div>
                        ...
                        <div class="mt-4">
                            <a href="" class="btn btn-soft-secondary btn-sm">Generate Reports <i class="mdi mdi-arrow-right ms-1"></i></a>
                        </div>
                    </div> <!-- end col-->
                    <div class="col-sm-5">
                        <div class="my-2">
