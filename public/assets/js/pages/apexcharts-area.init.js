...
var chartBarColors = getChartColorsArray("area_chart_basic");
var options = {
  series: [{
    name: "STOCK ABC",
...
var chartBarColors = getChartColorsArray("area_chart_spline");
var options = {
  series: [{
    name: 'series1',
...
var chartBarColors = getChartColorsArray("area_chart_datetime");
var timelinechart = {
  series: [{
...
var chartBarColors = getChartColorsArray("area_chart_negative");
var options = {
  series: [{
    name: 'North',
    data: [{
...
var chartBarColors = getChartColorsArray("area_chart-months");
var options = {
  series: [{
    name: 'commits',
...
chart.render();
var chartBarColors = getChartColorsArray("area_chart-years");
var optionsYears = {
  series: [{
    name: 'commits',
    data: githubdata.series
...
var chartBarColors = getChartColorsArray("area_chart_stacked");
var options = {
  series: [{
    name: 'South',
...
var chartBarColors = getChartColorsArray("area_chart_irregular");
var options = {
  series: [{
    name: 'PRODUCT A',
    data: dataSet[0]
...
var chartBarColors = getChartColorsArray("area-missing-null-value");
var options = {
  series: [{
    name: 'Network',
    data: [{
