...
var chartBarColors = getChartColorsArray("basic_candlestick");
var options = {
  series: [{
    data: [{
  ...
  plotOptions: {
    candlestick: {
      colors: {
        upward: chartBarColors[0],
        downward: chartBarColors[1]
      }
    }
  },
  title: {
...
var chartBarColors = getChartColorsArray("combo_candlestick");
var options = {
  series: [{
    data: seriesData
  }],
...
chart.render();
var chartBarColors = getChartColorsArray("combo_candlestick_chart");
var optionsBar = {
  series: [{
    name: 'volume',
...
var chartBarColors = getChartColorsArray("category_candlestick");
var options = {
  series: [{
    name: 'candle',
    data: [{
  ...
  annotations: {
    xaxis: [{
      x: 'Oct 06 14:00',
      borderColor: chartBarColors[0],
      label: {
        borderColor: chartBarColors[1],
        style: {
          fontSize: '12px',
          color: '#51d28c',
          background: chartBarColors[1]
        },
