...
var chartBarColors = getChartColorsArray("column_chart_datalabel");
var options = {
  chart: {
    height: 350,
    type: 'bar',
...
var chartBarColors = getChartColorsArray("column_stacked");
var options = {
  series: [{
    name: 'PRODUCT A',
...
var chartBarColors = getChartColorsArray("column_stacked_chart");
var options = {
  series: [{
    name: 'PRODUCT A',
...
var chartBarColors = getChartColorsArray("column_markers");
var options = {
  series: [{
    name: 'Actual',
    data: [{
...
var chartBarColors = getChartColorsArray("column_nagetive_values");
var options = {
  series: [{
    name: 'Cash Flow',
    ...
    bar: {
      colors: {
        ranges: [{
          from: -100,
          to: -46,
          color: chartBarColors[1]
        }, {
          from: -45,
          to: 0,
          color: chartBarColors[2]
        }]
      },
      columnWidth: '80%'
    }
...
var chartBarColors = getChartColorsArray("column_range");
var options = {
  series: [{
    data: [{
      x: 'Team A',
...
var chartBarColors = getChartColorsArray("chart-year");
var options = {
  series: [{
    data: makeData()
  }],
...
var chartBarColors = getChartColorsArray("column_distributed");
var options = {
  series: [{
