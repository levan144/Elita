...
/*!*************************************************!*\
  !*** ./resources/js/pages/invoice-list.init.js ***!
  \*************************************************/
/*
...
flatpickr('#datepicker-invoice'); // form step wizard
...
function nextPrev(n) {
  ...
  var x = document.getElementsByClassName("wizard-tab"); // Hide the current tab:
