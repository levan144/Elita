...
var chartBarColors = getChartColorsArray("basic_treemap");
var options = {
  series: [{
    data: [{
      x: 'New Delhi',
...
var chartBarColors = getChartColorsArray("multi_treemap");
var options = {
  series: [{
    name: 'Desktops',
    data: [{
...
var chartBarColors = getChartColorsArray("distributed_treemap");
var options = {
  series: [{
    data: [{
      x: 'New Delhi',
...
var chartBarColors = getChartColorsArray("color_range_treemap");
var options = {
  series: [{
    data: [{
      x: 'INTC',
