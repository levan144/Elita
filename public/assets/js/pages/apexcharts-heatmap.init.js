...
var generateData; // Heatmap Charts Generatedata

generateData = function generateData(count, yrange) {
  var i = 0;
  var series = [];
...
var chartBarColors = getChartColorsArray("basic_heatmap");
var options = {
  series: [{
    name: 'Metric1',
...
var chartBarColors = getChartColorsArray("multiple_heatmap");
var options = {
  series: data,
  chart: {
    height: 450,
...
var chartBarColors = getChartColorsArray("color_heatmap");
var options = {
  series: [{
    name: 'Jan',
...
var chartBarColors = getChartColorsArray("shades_heatmap");
var options = {
  series: [{
    name: 'Metric1',
    data: generateData(20, {
